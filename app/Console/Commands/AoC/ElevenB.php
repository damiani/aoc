...
class ElevenB extends Command
{
    protected $description = 'Day 11b: Hex Ed';
    protected $signature = 'aoc:11b {input}';
    ...
    {
        $this->info(
            $this->getInput()->map(function ($_, $steps) use ($path) {
                return $this->getShortestDistance($path->slice(0, $steps + 1));
            })->max()
        );
    }
